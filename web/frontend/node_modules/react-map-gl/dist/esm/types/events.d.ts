import type { ViewState, Point, LngLat, MapGeoJSONFeature } from 'react-map-gl/dist/esm/types/common';
import type { MapInstance, Evented, MarkerInstance, PopupInstance, GeolocateControlInstance } from 'react-map-gl/dist/esm/types/lib';
